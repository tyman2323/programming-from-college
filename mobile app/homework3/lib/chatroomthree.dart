...
class chatroomthree extends StatefulWidget {
  @override
  _chatroomthreestate createState() => _chatroomthreestate();
}

class _chatroomthreestate extends State<chatroomthree> {
  ...
  void sendMessage() async {
    ...
    firestore.collection('messages3').add({
